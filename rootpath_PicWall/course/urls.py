...
from .views import AboutView, CourseListView, CreateCourseView, CreateLessonView, DeleteCourseView, DetailLessonView, ListLessonView, ManageCourseListView, StudentListLessonView
