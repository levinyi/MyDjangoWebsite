"""
Django settings for rootpath_PicWall project.
...
SECRET_KEY = 'django-insecure-dqtoid=txfba@@0d3%ym8kvy43h_ru3k20qjx5i26bgq@+r*no'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.2.185', ]
...
WSGI_APPLICATION = 'rootpath_PicWall.wsgi.application'
